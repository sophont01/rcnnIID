...
for f=1:numel(R_list)
    ...
    [~,fName,~] = fileparts(fPath_parts{10});
    G.res_r = im2double(imread(fullfile('/media/saurabh/String/WORK/DATASETS/MPI-Sintel/training/albedo', fPath_parts{9}, [fName '.png'])));
    G.res_s = im2double(imread(fullfile('/media/saurabh/String/WORK/DATASETS/MPI-Sintel/full/training/SHADING', fPath_parts{9}, [fName '.png'])));
...
save('/media/saurabh/String/WORK/RESULTS/intrinsic_texture-master_RCNN/MPI/anyImageRCNN_clusterIID_VGG_fc6/rcnnIIDeval_MPI.mat', 'mseErrs_r', 'mseErrs_s', 'mseErrs_a', ...
